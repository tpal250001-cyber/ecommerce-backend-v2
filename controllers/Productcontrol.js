...
const { name,description,price,category,imageUrls,stock,createdate,rating } = req.body;
...
const { name,description,price,category,image,stock,createdate,rating } = req.body;
